...
const gradeThresholds = [
    ...
    { grade: 'B', min: 75, max: 79, gp: 3.00, remark: 'Satisfactory' },
    { grade: 'B-', min: 70, max: 74, gp: 2.70, remark: 'Fair' },
    { grade: 'C+', min: 65, max: 69, gp: 2.30, remark: 'Average' },
    { grade: 'C', min: 60, max: 64, gp: 2.00, remark: 'Below Average' },
    { grade: 'C-', min: 55, max: 59, gp: 1.70, remark: 'Poor' },
    { grade: 'D+', min: 50, max: 54, gp: 1.30, remark: 'Weak' },
    { grade: 'D', min: 45, max: 49, gp: 1.00, remark: 'Very Weak' },
    { grade: 'F', min: 0, max: 44, gp: 0.00, remark: 'Unsatisfactory' }
];
...
function getGradeColorClass(grade) {
    const gradeMap = {
        'A': 'grade-a-plus', // Use A+ color for highest
        'A-': 'grade-a',
        'B+': 'grade-b-plus',
        'B': 'grade-b',
        'B-': 'grade-b-minus',
