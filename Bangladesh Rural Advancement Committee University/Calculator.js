...
const gradeThresholds = [
    { grade: 'A+', min: 97, max: 100, gp: 4.00, remark: 'Exceptional' },
    { grade: 'A', min: 90, max: 96, gp: 4.00, remark: 'Excellent' },
    { grade: 'A-', min: 85, max: 89, gp: 3.70, remark: 'Very Good' },
    { grade: 'B+', min: 80, max: 84, gp: 3.30, remark: 'Good' },
    { grade: 'B', min: 75, max: 79, gp: 3.00, remark: 'Good' },
    { grade: 'B-', min: 70, max: 74, gp: 2.70, remark: 'Satisfactory' },
    { grade: 'C+', min: 65, max: 69, gp: 2.30, remark: 'Average' },
    { grade: 'C', min: 60, max: 64, gp: 2.00, remark: 'Fair' },
    { grade: 'C-', min: 57, max: 59, gp: 1.70, remark: 'Poor' },
    { grade: 'D+', min: 55, max: 56, gp: 1.30, remark: 'Very Poor' },
    { grade: 'D', min: 52, max: 54, gp: 1.00, remark: 'Poor' },
    { grade: 'D-', min: 50, max: 51, gp: 0.70, remark: 'Weak' },
    { grade: 'F', min: 0, max: 49, gp: 0.00, remark: 'Failure' }
];
